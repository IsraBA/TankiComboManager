// features/combos/view/lobby/lobby_button_injector.js
...
(function () {
  ...
  window.TankiQoL.LobbyButtonInjector = {
    injected: false,
    lobbyButton: null,
    ...
    inject() {
      ...
      const allPreviews = container.querySelectorAll(
        `${DOM.LOBBY_ITEM_PREVIEW}`,
      );
      const imageData = [];
