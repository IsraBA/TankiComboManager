// core/scanners/turret_augment_scanner.js
// סורק אוגמנטים לתותח - מזהה את האוגמנט המצויד ואת התמונה שלו
...
(function() {
    ...
    window.TankiComboManager.TurretAugmentScanner = {
        
        // פונקציה לזיהוי אוגמנט תותח מצויד
        async scanTurretAugment() {
