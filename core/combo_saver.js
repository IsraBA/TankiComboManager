  ...
  window.TankiComboManager.ComboSaver = {
    ...
    async saveCurrentCombo() {
      ...
      try {
        ...
        currentCombo.turret =
          window.TankiComboManager.BaseItemScanner.scanItem();

        // 2. סריקת אוגמנט תותח
        currentCombo.turretAugment =
          await window.TankiComboManager.AugmentScanner.scanAugment();
        ...
        currentCombo.drone = window.TankiComboManager.BaseItemScanner.scanItem(
          window.TankiComboManager.BaseItemScanner.cleanDroneName.bind(
        ...
        currentCombo.protection =
          window.TankiComboManager.ProtectionScanner.scanProtection();
        ...
        if (window.TankiComboManager.MenuInjector) {
          ...
          if (menuContainer) {
            ...
            if (comboTab) {
              ...
              await window.TankiComboManager.MenuInjector.safeActivateComboTab(
                comboTab,
                menuContainer,
                underline,
                150,
