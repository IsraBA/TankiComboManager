    ...
    async equipCombo(combo) {
      ...
      try {
        ...
        if (comboData.turret && !removedItems.turret) {
          await window.TankiComboManager.BaseItemEquipper.equipItem(
            comboData.turret,
            "Turrets",
            "Turret",
          );
        ...
        if (comboData.turretAugment && !removedItems.turretAugment) {
          await window.TankiComboManager.AugmentEquipper.equipAugment(
        ...
        if (window.TankiComboManager.TabNavigator) {
          await window.TankiComboManager.TabNavigator.navigateToTab(
            "Protection",
          );
        }
