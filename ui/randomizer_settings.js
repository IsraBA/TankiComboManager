...
(function () {
    ...
    window.TankiComboManager.RandomizerSettings = {
        drawer: null,
        initialized: false,
        ...
        init() {
            ...
            const Drawer = window.TankiComboManager.Drawer;
            const Switch = window.TankiComboManager.Switch;
            const Select = window.TankiComboManager.Select;
            const Randomizer = window.TankiComboManager.Randomizer;
            ...
            this.drawer = Drawer.create({
                ...
                imgSrc: 'https://s.eu.tankionline.com/static/images/imgModal.7d37b918.png'
            });
        ...
        _buildContent(LM, Switch, Select, Randomizer) {
            ...
            this.modeSelect = Select.create({
                ...
                options: [
                    { value: 'full_random', text: LM ? LM.getUIText('randomizerModeFullRandom') : 'Full random' },
                    { value: 'from_saved', text: LM ? LM.getUIText('randomizerModeFromSaved') : 'From saved combos' }
                ],
            ...
            catTitle.textContent = LM ? LM.getUIText('randomizerCategories') : 'Categories';
            ...
            const categoryRows = [
                [{ key: 'turrets', labelKey: 'randomizerTurrets', default: true },
                 { key: 'turretAugment', labelKey: 'randomizerTurretAugment', default: true }],
                [{ key: 'hulls', labelKey: 'randomizerHulls', default: true },
                 { key: 'hullAugment', labelKey: 'randomizerHullAugment', default: false }],
            ...
            advTitle.textContent = LM ? LM.getUIText('randomizerAdvanced') : 'Advanced';
            this.fullRandomContent.appendChild(advTitle);

            const advancedKeys = [
                { key: 'legendaryOnly', labelKey: 'randomizerLegendaryOnly', default: true },
                { key: 'maxEquipmentOnly', labelKey: 'randomizerMaxEquipmentOnly', default: true },
                { key: 'excludeBrutus', labelKey: 'randomizerExcludeBrutus', default: true },
                { key: 'excludeTsarGrenade', labelKey: 'randomizerExcludeTsarGrenade', default: true }
            ];
        ...
        _onModeChange(mode) {
            ...
            if (mode === 'from_saved') {
                ...
                this.fullRandomContent.classList.remove('cme_randomizer-section-hidden');
            }
        },
