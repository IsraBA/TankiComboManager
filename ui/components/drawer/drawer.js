// ui/components/drawer/drawer.js
...
(function () {
    ...
    window.TankiComboManager.Drawer = {
        ...
        create(options = {}) {
            ...
            function build() {
                ...
                closeBtnSpan.textContent = LM ? LM.getUIText('randomizerClose') : 'Close';
            ...
            function show() {
                ...
                escapeHandler = (e) => {
                    ...
                    if (e.key === 'Escape' || keyCode === 'Escape' || keyCode === 27 ||
            ...
            return {
                ...
                setContent,
                setContentElement,
                get element() { return rootElement; },
