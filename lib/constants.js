...
(function () {
    ...
    window.TankiComboManager.DOM = {
        ...
        CLAN_INDICATOR: ".ClanCommonStyle-center, .ClanCommonStyle-content, .ClanInfoComponentStyle-containerParametersClan, .FriendListComponentStyle-containerMembers", // הקונטיינר שמאפיין את מסך הקלאן (כולל טאב Members)
        ...
        GARAGE_BUTTON: ".PrimaryMenuItemComponentStyle-menuItemContainer .PrimaryMenuItemComponentStyle-itemLiGarage", // כפתור המוסך במסך הראשי
        ...
        AUGMENT_CATEGORY_LEGENDARY: "SkinCellComponentStyle-gradientCategoryDevices-LEGENDARY",
        AUGMENT_CATEGORY_EPIC: "SkinCellComponentStyle-gradientCategoryDevices-EPIC",
        AUGMENT_CATEGORY_COMMON: "SkinCellComponentStyle-gradientCategoryDevices-COMMON"
    };
})();