...
| -------------------------------------- | --------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| [`conventions.md`](conventions.md)     | writing or reviewing **any** code here                                      | comment budget, file headers, modularity, naming, CSS prefix, native look, error handling, **the end-of-round checklist**                    |
| [`architecture.md`](architecture.md)   | touching `manifest.json`, adding a file, or wondering where code may live   | the three execution contexts, the 7 manifest blocks and why, load order, namespaces, storage layout, the full source tree                    |
...
| [`advisor.md`](advisor.md)             | working on recommended protections                                          | what the battle state exposes and how it is trapped, the module↔turret map, the ranking, the protection-tab block, the product rules          |
...
`../../../research/CLAUDE.md`. Everything needed to _work on the extension_ is
here.
