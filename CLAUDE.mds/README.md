...
| [`advisor.md`](advisor.md)             | working on recommended protections (**POC**)                                | what the battle state exposes and how it is trapped, the module↔turret map, the product rules, how it grows into combo advice                 |
