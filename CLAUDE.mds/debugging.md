...
There are no automated tests in the repo. What exists is a set of **scratchpad
...
They are plain `node <file>` scripts with no dependencies. When you split or move
a file, update the file list at the top of the harness that loads it.
